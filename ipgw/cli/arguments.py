...
parser.add_argument('--bypass-system-proxy', action='store_true', help='禁用系统代理设置（默认启用系统代理）')
...
if args.bypass_system_proxy:
    # Disable all proxies only if --bypass-system-proxy is specified
    os.environ['NO_PROXY'] = '*'
if args.http_proxy:
